        ...
        <div class="text-center mb-16">
            ...
            <div class="logos">
                <div class="logos-slide">
                    <img src="{{ asset('images/logos/logos (1).png') }}" alt="Partner 1">
                    <img src="{{ asset('images/logos/logos (2).png') }}" alt="Partner 2">
                    <img src="{{ asset('images/logos/logos (3).png') }}" alt="Partner 3">
                    <img src="{{ asset('images/logos/logos (4).png') }}" alt="Partner 4">
                    <img src="{{ asset('images/logos/logos (5).png') }}" alt="Partner 5">
                    <img src="{{ asset('images/logos/logos (6).png') }}" alt="Partner 6">
                    <img src="{{ asset('images/logos/logos (7).png') }}" alt="Partner 7">
                    <img src="{{ asset('images/logos/logos (8).png') }}" alt="Partner 8">
                    <img src="{{ asset('images/logos/logos (9).png') }}" alt="Partner 9">
                    <img src="{{ asset('images/logos/logos (10).png') }}" alt="Partner 10">
                    <img src="{{ asset('images/logos/logos (11).png') }}" alt="Partner 11">
                </div>
                <script>
