...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-3xl font-bold text-gray-900 companies-count">{{ number_format($stats['total_companies']) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs md:text-sm font-medium text-gray-600">Total Deals</p>
                    <p class="text-xl md:text-3xl font-bold text-gray-900 deals-count">{{ number_format($stats['total_deals']) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl md:text-3xl font-bold text-gray-900 total-revenue">${{ number_format($stats['total_revenue']) }}</p>
                </div>
                <div class="w-8 h-8 md:w-12 md:h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                    <svg class="w-4 h-4 md:w-6 md:h-6 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
...
<!-- Create Deal Modal -->
<div id="createDealModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none; background-color: rgba(0, 0, 0, 0.5);">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto transform transition-all">
...
<div id="logInteractionModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none; background-color: rgba(0, 0, 0, 0.5);">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto transform transition-all">
