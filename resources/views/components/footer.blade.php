<footer class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div>
                ...
                <div>
                    ...
                    <form class="space-y-3" id="newsletterForm">
                        <input type="email" placeholder="Enter your email" class="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500" required>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div class="text-gray-400 text-sm mb-4 md:mb-0 select-none">
                © {{ date('Y') }} <span class="select-none pointer-events-none">Cliento</span>. All rights reserved.
            </div>
